.. entrenamiento.python_avanzado documentation master file, created by
...
.. note::
    ...
    Subir del nivel intermedio al nivel avanzado con explicaciones simples pero detalladas.
    ...
    **Sobre este entrenamiento**
    ...
    - Un entrenamiento de **nivel avanzado** (*2 días*) que cubre los *ocho (08) capítulos*.

.. warning::
   Si esta buscando los manuales y recursos del entrenamiento **Programación en Python 3 - Nivel avanzado** actualizados visite el siguiente enlace:
