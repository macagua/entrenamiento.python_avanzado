...
El repositorio del entrenamiento está disponible en la siguiente dirección:
   ...
   https://github.com/macagua/entrenamiento.python_avanzado/
...
.. contributors:: macagua/entrenamiento.python_avanzado
   :avatars:
   :limit: 1
...
* Consulte el `issue tracker <https://github.com/macagua/entrenamiento.python_avanzado/issues>`_ para obtener
