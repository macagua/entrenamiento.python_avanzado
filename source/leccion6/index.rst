...
.. literalinclude:: ../../recursos/leccion6/sqlite/sqlite3_record_insert.py
    :language: python
    :linenos:
    :lines: 1-55
...
.. important::
    ...
    siguiente enlace: :download:`sqlite3_record_insert.py <../../recursos/leccion6/sqlite/sqlite3_record_insert.py>`.
...
.. literalinclude:: ../../recursos/leccion6/sqlite/sqlite3_record_select.py
    :language: python
    :linenos:
    :lines: 1-51
...
.. important::
    Usted puede descargar el código usado en esta sección haciendo clic en el
    siguiente enlace: :download:`sqlite3_record_select.py <../../recursos/leccion6/sqlite/sqlite3_record_select.py>`.
...
.. literalinclude:: ../../recursos/leccion6/sqlite/sqlite3_record_update.py
    :language: python
    :linenos:
    :lines: 1-54
...
.. important::
    Usted puede descargar el código usado en esta sección haciendo clic en el
    siguiente enlace: :download:`sqlite3_record_update.py <../../recursos/leccion6/sqlite/sqlite3_record_update.py>`.
...
.. literalinclude:: ../../recursos/leccion6/sqlite/sqlite3_record_delete.py
    :language: python
    :linenos:
    :lines: 1-44
...
.. important::
    Usted puede descargar el código usado en esta sección haciendo clic en el
    siguiente enlace: :download:`sqlite3_record_delete.py <../../recursos/leccion6/sqlite/sqlite3_record_delete.py>`.
...
.. literalinclude:: ../../recursos/leccion6/sqlite/.env.example
    :language: text
    :linenos:
    :lines: 1-2
...
.. literalinclude:: ../../recursos/leccion6/sqlite/main.py
    :language: python
    :linenos:
    :lines: 1-136
...
.. literalinclude:: ../../recursos/leccion6/sqlite/requirements.txt
    :language: python
    :linenos:
    :lines: 1-2
...
.. literalinclude:: ../../recursos/leccion6/sqlite/settings.py
    :language: python
    :linenos:
    :lines: 1-32
...
.. important::
    ...
    - :download:`__init__.py <../../recursos/leccion6/sqlite/__init__.py>`.

    - :download:`.env.example <../../recursos/leccion6/sqlite/.env.example>`.

    - :download:`main.py <../../recursos/leccion6/sqlite/main.py>`.

    - :download:`requirements.txt <../../recursos/leccion6/sqlite/requirements.txt>`.

    - :download:`settings.py <../../recursos/leccion6/sqlite/settings.py>`.

    - :download:`sistema.db <../../recursos/leccion6/sqlite/sistema.db>`.
