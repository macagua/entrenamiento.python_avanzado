...
.. important::
    ...
    siguiente enlace: :download:`postgresql_record_insert.py <../../recursos/leccion6/postgresql/crud/postgresql_record_insert.py>`.
...
.. important::
    Usted puede descargar el código usado en esta sección haciendo clic en el
    siguiente enlace: :download:`postgresql_record_select.py <../../recursos/leccion6/postgresql/crud/postgresql_record_select.py>`.
...
.. important::
    Usted puede descargar el código usado en esta sección haciendo clic en el
    siguiente enlace: :download:`postgresql_record_update.py <../../recursos/leccion6/postgresql/crud/postgresql_record_update.py>`.
...
.. important::
    Usted puede descargar el código usado en esta sección haciendo clic en el
    siguiente enlace: :download:`postgresql_record_delete.py <../../recursos/leccion6/postgresql/crud/postgresql_record_delete.py>`.
